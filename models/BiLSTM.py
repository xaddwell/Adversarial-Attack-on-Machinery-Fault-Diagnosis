...
class BiLSTM(nn.Module):
    def __init__(self, in_channels=1, n_class=10):
        ...
        self.embed1 = nn.Sequential(
            nn.Conv1d(in_channels, self.kernel_num, kernel_size=3, padding=1),
        ...
        self.hidden2label2 = nn.Linear(self.hidden_dim * 4, n_class)
